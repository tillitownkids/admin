      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
        {episodes.map((ep) => (
          <div 
            ...
            className={`cursor-pointer group flex flex-col p-6 rounded-2xl border transition-all duration-300 ${ selectedEpisodeNumber === ep.episodeNumber ? 'bg-primary/10 border-primary transform scale-[1.02]' : 'bg-card border-border hover:border-primary/50' }`}
          >
